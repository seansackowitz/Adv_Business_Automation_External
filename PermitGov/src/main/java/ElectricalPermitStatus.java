...
public class ElectricalPermitStatus
{
    ...
    public static ElectricalPermitStatus CreatePermit()
    {
        lastID++;
        database.put((Integer)lastID, 0);
        return new ElectricalPermitStatus(lastID, false);
    }
    ...
    public ElectricalPermitStatus(int id)
    {
        this.id = id;
        if (id > -1)
        {
    ...
    public ElectricalPermitStatus(int id, boolean update)
    {
        this.id = id;
        if (id > -1)
        {
